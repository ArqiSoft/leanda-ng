...
This directory contains specifications extracted from legacy .NET services by Agent 0: Legacy Spec Extractor.
...
│   └── core-api.yaml           # Core API endpoints (✅ Complete)
...
│   └── core-services-plan.md   # .NET to Quarkus mapping (✅ Complete)
...
- **Nodes API**: GET/POST nodes, inner nodes, public nodes, ZIP download
- **Entities API**: CRUD for files, folders, records, models; blobs, images, metadata
- **Users API**: User management, public info
...
- Entities: User, File, Folder, Record, Model, Node
- Value Objects: AccessPermissions, Image, Blob, KeyValue, Property
- MongoDB indexes defined for each entity
